        ...
        >
            ...
            <div className="absolute inset-0 w-full h-full">
                {/* <iframe
                    ...
                    src={`https://www.youtube.com/embed/${trailerId}?autoplay=1&mute=1&controls=0&showinfo=0&modestbranding=1&rel=0&loop=1&playlist=${trailerId}&vq=hd1080&playsinline=1&disablekb=1&iv_load_policy=3`}
            ...
            {/* Multi-layered gradient overlay (Netflix style) */}
            <div className="absolute inset-0 bg-gradient-to-r from-black via-transparent to-transparent"></div>
            <div className="absolute bottom-0 left-0 w-full h-96 bg-gradient-to-t from-black via-black/50 to-transparent"></div>
            <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-black/80 to-transparent"></div>

            {/* Content overlay - Netflix positioning */}
            <div className="absolute bottom-[25%] left-12 text-white max-w-[36%] z-10">
                <h1 className="text-5xl font-bold mb-4 drop-shadow-2xl leading-tight">
                    {filterMovie?.title || filterMovie?.name || "MOVIE TITLE"}
                </h1>
                <p className="text-base leading-relaxed mb-5 drop-shadow-lg font-normal">
